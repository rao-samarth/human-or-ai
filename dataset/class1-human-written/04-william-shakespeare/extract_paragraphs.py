...
# It is used for random paragraph extraction from Shakespeare books.

"""
Script to extract paragraphs from Shakespeare books.
...
def main():
    ...
    for book_filename in selected_books:
        book_path = script_dir / 'full-books' / book_filename
